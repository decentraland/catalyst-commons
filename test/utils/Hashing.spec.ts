...
describe('Hashing', () => {
  ...
  it('v1 hashes multiple files correctly 1', async () => {
    ...
    files.set('a.png', 'bafybeibdik2ihfpcdi7aaaguptwcoc5msav7uhn5hu54xlq2pdwkh5arzy')
  ...
  it('v1 hashes multiple files correctly 2', async () => {
    const files = new Map<string, string>()
    files.set('a.png', 'bafybeibdik2ihfpcdi7aaaguptwcoc5msav7uhn5hu54xlq2pdwkh5arzy')
    files.set('a/b.png', 'bafybeibdik2ihfpcdi7aaaguptwcoc5msav7uhn5hu54xlq2pdwkh5asd')
    const { hash } = await Hashing.calculateMultipleHashesADR32(files)
